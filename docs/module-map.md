...
| engine/critic-prompt.md | Промпт агента-КРИТИКА — судит против тех же 7 пунктов DoD, findings `{rung_index, issue, fix}`. ⚠️ Пока недостаточно строг: пропускает часть нарушений (leak в опциях, двойной вопрос) — нужен зубастее (обновлено 2026-06-24) |
