...
export const wrongTasks: WrongTask[] = [
  // Лесенки авторил движок cabinet/engine на Sonnet (автор → усиленный критик по DoD-7).
  // Ручная правка: PC04 ступень 2 — убрал предсказанную базу из вопроса (критик проспал утечку DoD-4).
  {
    id: "a",
    nodeId: "PC02",
    topicLabel: "проценты",
    ...
    steps: [
      {
        ...
        kind: "compute",
        microSkill: "percent_increase",
        instruction: "Цена фотоаппарата выросла на $20\\%$. Найди новую цену после повышения (в тенге).",
        expected: "30000",
        reveal: "$25\\,000 + 20\\%\\cdot25\\,000 = 25\\,000 + 5000 = 30\\,000$ тенге.",
      },
      {
        n: 2,
        kind: "choose",
        microSkill: "percent_change",
        instruction: "Теперь цена понижается на $20\\%$. От какой суммы считаем это понижение?",
        options: [
          { id: "o0", label: "От $25\\,000$ тенге" },
          { id: "o1", label: "От $30\\,000$ тенге" },
          { id: "o2", label: "От $5000$ тенге" },
        ],
        expected: "o1",
        reveal:
          "Понижение считается от той цены, которая есть сейчас — то есть от $30\\,000$. Исходные $25\\,000$ уже не актуальны.",
      },
      {
        n: 3,
        kind: "compute",
        microSkill: "percent_change",
        instruction: "Найди цену фотоаппарата после понижения на $20\\%$.",
        expected: "24000",
        reveal:
          "$30\\,000 - 20\\%\\cdot30\\,000 = 30\\,000 - 6000 = 24\\,000$ тенге. Плюс и минус на одинаковый процент не компенсируют друг друга.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        kind: "compute",
        microSkill: "frac_of_remaining",
        instruction: "После первого дня турист прошёл $\\frac{1}{4}$ пути. Какая доля пути осталась?",
        expected: "3/4",
        reveal: "$1 - \\frac{1}{4} = \\frac{3}{4}$ — столько пути оставалось после первого дня.",
      },
      {
        n: 2,
        kind: "choose",
        microSkill: "frac_of_remaining",
        instruction:
          "Во второй день турист прошёл половину остатка. Значит, $36$ км третьего дня составляют какую долю всего пути?",
        options: [
          { id: "o0", label: "$\\frac{1}{2}$" },
          { id: "o1", label: "$\\frac{3}{8}$" },
          { id: "o2", label: "$\\frac{3}{4}$" },
        ],
        expected: "o1",
        reveal:
          "Половина от $\\frac{3}{4}$ — это $\\frac{1}{2}\\cdot\\frac{3}{4}=\\frac{3}{8}$. Именно столько осталось на третий день, а не $\\frac{1}{2}$ всего пути.",
      },
      {
        n: 3,
        kind: "compute",
        microSkill: "div_frac",
        instruction: "$36$ км — это $\\frac{3}{8}$ всего пути. Найди длину всего пути (в км).",
        expected: "96",
    ...
    steps: [
      {
        ...
        microSkill: "work_rate",
        instruction:
          "Вместе они делают работу за $6$ часов, а первый — за $15$ часов. Что нужно сделать, чтобы найти производительность второго рабочего?",
        options: [
          { id: "o0", label: "Вычесть времена: $15 - 6$" },
          { id: "o1", label: "Вычесть доли работы в час" },
          { id: "o2", label: "Сложить времена: $15 + 6$" },
        ],
        expected: "o1",
        reveal:
          "Производительность — это доля работы за час. Вместе: $\\frac{1}{6}$ работы/ч, первый: $\\frac{1}{15}$ работы/ч. Вычитаем доли, не часы — иначе смысл теряется.",
      },
      {
        n: 2,
        kind: "compute",
        microSkill: "addsub_frac",
        instruction: "Найди производительность второго рабочего: $\\frac{1}{6} - \\frac{1}{15}$.",
        expected: "1/10",
        reveal:
          "Приводим к общему знаменателю $30$: $\\frac{5}{30} - \\frac{2}{30} = \\frac{3}{30} = \\frac{1}{10}$ работы в час.",
      },
      {
        n: 3,
        kind: "compute",
        microSkill: "time_from_rate",
        instruction: "Второй рабочий делает $\\frac{1}{10}$ работы в час. За сколько часов он выполнит всю работу?",
        expected: "10",
        reveal: "Если за час делается $\\frac{1}{10}$, то вся работа займёт $1 \\div \\frac{1}{10} = 10$ часов.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        kind: "compute",
        microSkill: "ratio_parts",
        instruction: "Отношение мальчиков к девочкам $8 : 5$. На сколько частей мальчиков больше, чем девочек?",
        expected: "3",
        reveal: "$8 - 5 = 3$ части. Это «лишние» мальчики сверх числа девочек.",
      },
      {
        n: 2,
        kind: "choose",
        microSkill: "percent_base_choice",
        instruction:
          "Вопрос: на сколько процентов мальчиков больше, ЧЕМ девочек. Какую дробь нужно перевести в проценты?",
        options: [
          { id: "o0", label: "$\\frac{3}{8}$" },
          { id: "o1", label: "$\\frac{3}{5}$" },
          { id: "o2", label: "$\\frac{8}{5}$" },
        ],
        expected: "o1",
        reveal:
          "«Больше, ЧЕМ девочек» → база сравнения это девочки ($5$ частей), не мальчики. Поэтому $3 \\div 5$, а не $3 \\div 8$.",
      },
      {
        n: 3,
        kind: "compute",
        microSkill: "frac_to_percent",
        instruction: "Переведи $\\frac{3}{5}$ в проценты. Сколько получается?",
        expected: "60",
    ...
    steps: [
      {
        ...
        microSkill: "time_from_distance_speed",
        instruction:
          "Сначала переведём время в часы. Теплоход шёл по течению $3$ ч $20$ мин. Сколько это часов? Введи дробь.",
        expected: "10/3",
        reveal: "$3$ ч $20$ мин $= 3 + \\frac{20}{60} = \\frac{10}{3}$ ч. Двадцать минут — это треть часа.",
      },
      {
        n: 2,
        kind: "compute",
        microSkill: "distance_speed_time",
        instruction: "Расстояние $80$ км, время по течению $\\frac{10}{3}$ ч. Какова скорость теплохода по течению (км/ч)?",
        expected: "24",
        reveal: "$80 \\div \\frac{10}{3} = 80\\cdot\\frac{3}{10} = 24$ км/ч.",
      },
      {
        n: 3,
        kind: "compute",
        microSkill: "distance_speed_time",
        instruction: "Расстояние то же — $80$ км, но против течения теплоход шёл $5$ ч. Какова скорость против течения (км/ч)?",
        expected: "16",
        reveal: "$80 \\div 5 = 16$ км/ч.",
      },
      {
        n: 4,
        kind: "choose",
        microSkill: "stream_speed_half_diff",
        instruction:
          "Ты нашёл: скорость по течению $24$ км/ч, против течения $16$ км/ч. Какова скорость течения реки?",
        options: [
          { id: "o0", label: "$8$ км/ч" },
          { id: "o1", label: "$4$ км/ч" },
          { id: "o2", label: "$20$ км/ч" },
        ...
        expected: "o1",
        reveal:
          "По течению скорость теплохода больше на скорость течения, против — меньше на неё. Значит разность $24 - 16 = 8$ вмещает два течения: $8 \\div 2 = 4$ км/ч.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        kind: "choose",
        microSkill: "phrase_to_operation",
        instruction: "Сестрёнка в $3$ раза младше Адилета. Если Адилету $x$ лет, как записать возраст сестрёнки?",
        options: [
          { id: "o0", label: "$x - 3$" },
          { id: "o1", label: "$\\frac{x}{3}$" },
          { id: "o2", label: "$3x$" },
        ],
        expected: "o1",
        reveal:
          "«В $3$ раза младше» — делим: $x \\div 3 = \\frac{x}{3}$. «На $3$ младше» было бы $x - 3$ — это разные конструкции.",
      },
      {
        n: 2,
        kind: "choose",
        microSkill: "phrase_to_operation",
        instruction: "Отец в $3$ раза старше Адилета. Как записать возраст отца?",
        options: [
          { id: "o0", label: "$x + 3$" },
          { id: "o1", label: "$\\frac{x}{3}$" },
          { id: "o2", label: "$3x$" },
        ...
        expected: "o2",
        reveal: "«В $3$ раза старше» — умножаем: $3\\cdot x = 3x$. «На $3$ старше» было бы $x + 3$.",
      },
      {
        n: 3,
        kind: "compute",
        microSkill: "solve_linear",
        instruction:
          "Все пятеро: Адилет $x$, старший брат $x+3$, младший $x-3$, сестрёнка $\\frac{x}{3}$, отец $3x$. Сложи их и приравняй к $133$. Какой коэффициент при $x$ получится (дробью)?",
        expected: "19/3",
        reveal:
          "Целые: $x+x+x+3x = 6x$, дробное: $\\frac{x}{3}$. Итого $\\frac{18x+x}{3} = \\frac{19x}{3}$, уравнение $\\frac{19x}{3} = 133$.",
      },
      {
        n: 4,
        kind: "compute",
        microSkill: "solve_linear",
        instruction: "Уравнение $\\frac{19x}{3} = 133$. Сколько лет Адилету?",
        expected: "21",
        reveal: "Умножаем обе части на $3$: $19x = 399$, делим на $19$: $x = 21$.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        microSkill: "count_multiples_in_range",
        instruction:
          "Наименьшее трёхзначное число, кратное $5$ — это $100$. Каково наибольшее трёхзначное число, кратное $5$?",
        expected: "995",
        reveal: "Последнее трёхзначное число — $999$, но оно не делится на $5$. Ближайшее снизу — $995$.",
      },
      {
        n: 2,
        kind: "choose",
        microSkill: "fencepost_gaps_vs_items",
        instruction:
          "Числа $100, 105, 110, \\ldots, 995$ — арифметическая прогрессия с шагом $5$. Сколько в ней членов?",
        options: [
          { id: "o0", label: "$179$" },
          { id: "o1", label: "$180$" },
          { id: "o2", label: "$200$" },
        ...
        expected: "o1",
        reveal:
          "$(995 - 100)/5 = 179$ — это число промежутков, а самих чисел на одно больше: $179 + 1 = 180$. Как заборные столбики: их на один больше, чем пролётов.",
      },
      {
        n: 3,
        kind: "compute",
        microSkill: "arithmetic_series_sum",
        instruction:
          "Используя формулу суммы прогрессии $S = n\\cdot\\frac{a_1 + a_n}{2}$, найди сумму всех трёхзначных кратных $5$. Все нужные значения ты уже нашёл.",
        expected: "98550",
        reveal: "$S = 180\\cdot\\frac{100 + 995}{2} = 180\\cdot547{,}5 = 98\\,550$.",
      },
    ],
  },
];
