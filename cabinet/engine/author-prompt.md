...
- **Дробление (нарушает п.1):** «найди 20% от 25000» + «прибавь» = ОДНА ступень «цена выросла на 20%». «Раздели 3 на 5» + «переведи в %» = одна ступень «сколько процентов 3 от 5». «Найди дробь» + «вычисли её» — один ход.
...
- **Ответ/формула в варианте (нарушает п.4):** варианты `choose` — это голые значения или короткие фразы. НЕ пиши в опции формулу решения («$(24-16)\div2$», «$\frac{1}{6}-\frac{1}{15}$», «$=4$»). Дай голые значения, один из которых = реальная ошибка ребёнка (его число): например `[8 / 4 / 20]`, где 8 — его ошибка.
