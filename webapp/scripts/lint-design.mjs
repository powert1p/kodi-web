#!/usr/bin/env node
// Гейт дизайн-системы v11 «Лента решения»: ловит сырые значения прямо в исходниках,
// без внешних зависимостей. Все v11-токены (paper/ink/orange/sage, radii, тени)
// живут в tokens.css/fonts.css — гейт их НЕ трогает, но ловит любой сырой
